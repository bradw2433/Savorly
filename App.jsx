  ...
  return (
    <div style={{position:'fixed',inset:0,background:T.black,zIndex:100,overflow:'hidden',display:'flex',flexDirection:'column'}}>
      ...
      <div style={{position:'relative',minHeight:260,flexShrink:0,overflow:'hidden'}}>
        ...
        <button onClick={handleFavoriteClick} style={{position:'absolute',top:20,right:20,width:42,height:42,background:localFavorited?T.brass:'rgba(0,0,0,.5)',border:`1px solid ${localFavorited?T.brass:T.border}`,borderRadius:'50%',display:'flex',alignItems:'center',justifyContent:'center',transition:'all .3s',transform:heartBounce?'scale(1.35)':'scale(1)'}}>
